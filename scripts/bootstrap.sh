...
until [ "$(docker run --rm --network redis lucasvieir4/redis-utils:$TAG \
...
old_master=$(docker run --rm --network redis lucasvieir4/redis-utils:$TAG \
...
docker run --rm --network redis lucasvieir4/redis-utils:$TAG \
